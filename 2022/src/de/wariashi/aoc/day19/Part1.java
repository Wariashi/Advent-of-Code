...
public class Part1 {
	public static void main(String[] args) {
		...
		for (var blueprint : blueprints) {
			...
			var geodes = getMostGeodesFor(blueprint, new Inventory(0, 0, 0, 0), new RobotFarm(1, 0, 0, 0), 24);
			var quality = blueprint.getId() * geodes;
			System.out.println(geodes + " geodes, resulting in a quality level of " + quality);
