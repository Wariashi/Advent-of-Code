...
public class Part1 {
	...
	public static void main(String[] args) {
		...
		printMap();
		var boundingRectangle = getBoundingRectangle();
		System.out.println(getEmptyTilesInArea(boundingRectangle));
	}
	...
	private static Rectangle getBoundingRectangle() {
	...
	private static int getEmptyTilesInArea(Rectangle rectangle) {
		var emptyTiles = 0;
